...
class NewsfeedsControllerTest < ActionController::TestCase
  ...
  test "should create newsfeed" do
    assert_difference('Newsfeed.count') do
      post :create, newsfeed: { content: @newsfeed.content, timestamp: @newsfeed.timestamp, title: @newsfeed.title }
    end
  ...
  test "should update newsfeed" do
    patch :update, id: @newsfeed, newsfeed: { content: @newsfeed.content, timestamp: @newsfeed.timestamp, title: @newsfeed.title }
    assert_redirected_to newsfeed_path(assigns(:newsfeed))
  end
