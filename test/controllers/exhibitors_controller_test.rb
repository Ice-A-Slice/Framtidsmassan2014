...
class ExhibitorsControllerTest < ActionController::TestCase
  ...
  test "should create exhibitor" do
    assert_difference('Exhibitor.count') do
      post :create, exhibitor: { category_id: @exhibitor.category_id, link: @exhibitor.link, position: @exhibitor.position, title: @exhibitor.title }
    end
  ...
  test "should update exhibitor" do
    patch :update, id: @exhibitor, exhibitor: { category_id: @exhibitor.category_id, link: @exhibitor.link, position: @exhibitor.position, title: @exhibitor.title }
    assert_redirected_to exhibitor_path(assigns(:exhibitor))
  end
